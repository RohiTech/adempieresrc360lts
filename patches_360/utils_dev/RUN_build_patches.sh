...
jar cf patches_${ADEMPIERE_VERSION_FILE}_$TODAY.jar -C $BUILD_DIR .
md5sum patches_${ADEMPIERE_VERSION_FILE}_$TODAY.jar > patches_${ADEMPIERE_VERSION_FILE}_$TODAY.jar.MD5

ls -l $ADEMPIERE_INSTALL/$TODAY/patches_${ADEMPIERE_VERSION_FILE}_$TODAY.jar

cp patches_${ADEMPIERE_VERSION_FILE}_$TODAY.jar $ADEMPIERE_ROOT/lib/patches.jar
